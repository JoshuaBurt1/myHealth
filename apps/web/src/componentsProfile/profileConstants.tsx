...
export const STRENGTH_KEY_MAP: Record<string, string> = {
  ...
  'Dumbbell Lateral Raise': 'dbLateralRaise',
  ...
  // Arms & Bodyweight Accessories
  'Dips': 'dips',
  'Barbell Bicep Curl': 'bbBicepCurl',
  'Barbell Reverse Curl': 'bbReverseCurl',
...
export const SPEED_KEY_MAP: Record<string, string> = {
  ...
  'Bike 10k': 'bike10k',
  'Bike Marathon': 'bikeMarathon',
  'Rowing machine 100m': 'row100m',
...
{ 
  ...
  { key: 'squat', title: 'SQUAT', unit: 'kg', icon: <Dumbbell className="text-indigo-700" />, color: '#312e81' },
  { key: 'frontSquat', title: 'FRONT SQUAT', unit: 'kg', icon: <Dumbbell className="text-indigo-700" />, color: '#1e1b4b' },
  { key: 'overheadSquat', title: 'OVERHEAD SQUAT', unit: 'kg', icon: <Dumbbell className="text-indigo-700" />, color: '#2e1065' },
  { key: 'gobletSquat', title: 'GOBLET SQUAT', unit: 'kg', icon: <Dumbbell className="text-purple-600" />, color: '#7e22ce' },
  { key: 'legPress', title: 'LEG PRESS', unit: 'kg', icon: <Dumbbell className="text-purple-700" />, color: '#6b21a8' },
  { key: 'legExtension', title: 'LEG EXTENSION', unit: 'kg', icon: <Dumbbell className="text-purple-800" />, color: '#581c87' },
  { key: 'bulgarianSplitSquat', title: 'BULGARIAN SPLIT SQUAT', unit: 'kg', icon: <Dumbbell className="text-fuchsia-600" />, color: '#c026d3' },
  { key: 'deadlift', title: 'DEADLIFT', unit: 'kg', icon: <Dumbbell className="text-indigo-800" />, color: '#a21caf' },
  { key: 'sumoDeadlift', title: 'SUMO DEADLIFT', unit: 'kg', icon: <Dumbbell className="text-fuchsia-800" />, color: '#86198f' },
  { key: 'romanianDeadlift', title: 'ROMANIAN DEADLIFT', unit: 'kg', icon: <Dumbbell className="text-pink-700" />, color: '#be185d' },
  { key: 'goodMorning', title: 'GOOD MORNING', unit: 'kg', icon: <Dumbbell className="text-pink-800" />, color: '#9d174d' },
  ...
  { key: 'dbInclinePress', title: 'DUMBBELL INCLINE PRESS', unit: 'kg', icon: <Dumbbell className="text-blue-500" />, color: '#1e40af' },
  { key: 'dbOverheadPress', title: 'DUMBBELL OVERHEAD PRESS', unit: 'kg', icon: <Dumbbell className="text-blue-500" />, color: '#1e3a8a' },
  { key: 'dbLateralRaise', title: 'DUMBBELL LATERAL RAISE', unit: 'kg', icon: <Dumbbell className="text-sky-500" />, color: '#0284c7' },
