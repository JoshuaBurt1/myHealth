...
const Intervention = React.lazy(() => import('./componentsGroupScreen/Intervention'));
    ...
    <div className="max-w-7xl mx-auto p-0 md:p-6 bg-slate-50 min-h-screen pb-20 relative">
      <div className="contents md:flex md:flex-col md:flex-1 md:bg-white md:rounded-3xl md:shadow-sm md:border md:border-slate-100 md:mt-2 md:overflow-hidden">        
          ...
          <div className="flex-1 px-6 md:px-8 flex flex-col justify-center">
            <h2 className="text-xl md:text-2xl font-black text-slate-800 flex items-center gap-3 tracking-tight">
              {activeTab === 'cohort' ? (
                ...
                <><LineChart className="text-emerald-500" size={28} /> Correlation </>
              ) : activeTab === 'hypothesis-test' ? (
                <><FlaskConical className="text-emerald-500" size={28} /> Intervention</>
              ) : activeTab === 'my-groups' ? (
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          {/* My Groups, Create Group, Cohort, Correlation, Intervention content (explanations) */}
          {activeTab === 'hypothesis-test' ? (
            <div className="p-0 md:p-6 max-w-5xl mx-auto">
              ...
              {!hasStartedHypothesis ? (
                ...
                <div className="bg-white rounded-4xl border border-slate-100 shadow-sm p-8 md:p-12 text-center mt-4 md:mt-0">
                  ...
                  <h3 className="text-2xl font-black text-slate-800 mb-4">Intervention</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left mb-10">
                    ...
                    <div className="p-4 border border-slate-100 rounded-2xl bg-slate-50/50">
                      ...
                      <p className="text-xs text-slate-500 italic ml-6">
                        "Did the time period when I exceeded my calorie threshold result in weight gain, compared to the time period that I did not exceed it?"
                      </p>
                    </div>

                    {/* Card 2: Contamination */}
                    <div className="p-4 border border-slate-100 rounded-2xl bg-slate-50/50">
                      <div className="flex items-start gap-2 mb-2">
                        <Activity className="w-4 h-4 text-slate-400 mt-0.5" />
                        <p className="text-slate-800 text-sm leading-relaxed">
            ...
            {!hasStartedCorrelation ? (
              <div className="bg-white rounded-4xl border border-slate-100 shadow-sm p-8 md:p-12 text-center mt-4 md:mt-0">
                ...
                <p className="text-slate-600 max-w-lg mx-auto mb-8">
                  ...
                  impacts your weight or how diet changes correlate with your heart rate.
                </p>
