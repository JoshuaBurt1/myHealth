...
import { Shield, Users, Globe, UserPlus, X, Check, BookOpen } from 'lucide-react';
...
export const ModalSettings: React.FC<PrivacySettingsModalProps> = ({
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      ...
      // Start loading every time the modal opens
      ...
      try {
        ...
        // 2. Stop loading regardless of success/fail
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl w-full max-w-md p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        {/* 3. Conditional Rendering for the Settings List */}
        <div className="space-y-4">
          {initialLoading ? (
            // Skeleton Loader to prevent the "green-to-off" shift
            <>
            ...
            <>
              <PrivacyToggle 
                icon={<Users size={20} />}
                title="Followers"
                description="Allow your followers to view your profile"
              ...
              <PrivacyToggle 
                ...
                title="Following"
                description="Allow the people you follow to view your profile"
                isActive={settings.allowFollowing}
                onToggle={() => handleToggle('allowFollowing')}
              />
              <PrivacyToggle 
                icon={<Globe size={20} />}
                title="Public"
