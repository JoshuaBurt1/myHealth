...
const ForumScreen: React.FC = () => {
  ...
  // Window resize listeners (mobile to desktop view change)
  useEffect(() => {
  ...
  const renderFilterContent = () => (
    <div className="p-4 space-y-4">
      ...
      <div className={`transition-all duration-500 ease-in-out ${
        isMapExpanded && isMobile ? 'h-96' : 'h-48'
      }`}>
        <ExpandableMap 
          ...
          radius={radius}
          isExpanded={isMapExpanded} // Controlled prop
          onToggleExpand={() => setIsMapExpanded(!isMapExpanded)} // Controlled toggle
        />
      </div>
