...
const PaymentScreen: React.FC = () => {
  ...
  const [isProcessing, setIsProcessing] = useState(false); // Track DB transaction
  ...
  const handleSuccessfulPayment = async (details: any) => {
    ...
    try {
      ...
      setIsProcessing(false); // End overlay
    }
  };
        ...
        <div className="grid gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm min-h-75">
            <PayPalButtons 
              ...
              disabled={isProcessing} // Disable PayPal buttons while processing
