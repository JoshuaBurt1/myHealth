    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white w-full max-w-md rounded-3xl p-3 relative shadow-2xl overflow-y-auto max-h-[90vh] custom-scrollbar">        
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="space-y-1 mb-0.5">
            <div className="flex justify-between items-center ml-1">
               ...
               <span className="text-[10px] text-slate-400">{postTitle.length}/50</span>
            </div>
            <input 
              autoFocus
              maxLength={50}
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
              <div className="space-y-1 mb-0.5">
                <div className="flex justify-between items-center ml-1">
                  ...
                  <span className="text-[10px] text-slate-400">{pollContent.length}/500</span>
                </div>
                <textarea 
                  maxLength={500}
                  className="w-full bg-indigo-50/30 border border-slate-200 p-4 rounded-2xl outline-none focus:border-indigo-500 font-normal text-slate-600 min-h-24 resize-none"
            ...
            <div className="space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <div className="flex flex-col gap-2 p-3 bg-slate-50 border border-slate-200 rounded-2xl">
                {popHealthCategory === 'hazard' && (
                  <>
                    <select 
                      className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-sm text-slate-600 outline-none focus:border-indigo-500"
                      value={hazardType}
          ...
          <div className="flex items-center justify-between bg-slate-50 border border-slate-200 rounded-xl p-3">
            ...
            <button 
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold ${postLocation ? 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200' : 'bg-slate-200 text-slate-600 hover:bg-slate-300'}`}
            >
        ...
        <div className="flex gap-3 mt-4">
          <button onClick={onClose} className="flex-1 py-3 text-slate-500 bg-slate-100 rounded-xl font-bold hover:bg-slate-200 transition-colors">Cancel</button>
          <button onClick={onCreate} className="flex-1 py-3 bg-indigo-600 text-white rounded-xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-colors">
            Publish
          </button>
        </div>
      </div>
